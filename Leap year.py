...
class SayDays:
    def __init__(self, year, month : int, day : int):
        self.year = year
        self.month = month
        self.day = day
    ...
    def days(self) -> int:
        ...
        # Add the days in this month until today (given date0
        total += self.day # property noyt function return
        return total
    ...
    def weekday_name(self):
        ...
        return names[self.weekdsy()] #5 ->"Thursday"
